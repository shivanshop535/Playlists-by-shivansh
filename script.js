...
const channels = [
    { name: 'Nobita Aur Dinosaur Yoddha', url: 'https://dcoolf2l-b0e5bd96bf18.herokuapp.com/dl/671b2f5349786ef3e4a92b68', category: 'movies' },
    { name: 'Nobita Bana Superhero', url: 'https://dcoolf2l-b0e5bd96bf18.herokuapp.com/dl/671b2f9e49786ef3e4a92b6a', category: 'movies' },
...
categorySelect.addEventListener('change', () => {
    ...
    const filteredChannels = selectedCategory === 'all' ? channels : channels.filter(channel => channel.category === selectedCategory);
    displayChannels(filteredChannels);
});
